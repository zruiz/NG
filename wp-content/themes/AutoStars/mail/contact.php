...
$page_id = $recipients-2648;
$recipients_email = get_post_meta($page_id,'imic_contact_email',true);
$recipients_email = ($recipients_email!='')?$recipients_email:get_option('admin_email');
$e_body = "You have been contacted by $fname $lname, their additional message is as follows." . PHP_EOL . PHP_EOL;
$e_content = '';
$e_content .= "Name: $fname $lname" . PHP_EOL . PHP_EOL;
