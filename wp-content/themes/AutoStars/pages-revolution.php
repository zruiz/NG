...
<!-- Search Form -->
        <div class="floated">
            <div class="search-form">
          		<h2><?php echo esc_attr_e('Your Trusted Resource For All European Yacht Brands Purchase & Sales','framework'); ?></h2>
                <p><?php echo esc_attr_e('Private sales, bank owned yachts, trades and more…','framework'); ?></p>
