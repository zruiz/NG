        ...
        <div id="content" class="content full">
            ...
            <div class="row">
                <div class="icon-actions" style="padding-bottom: 20px;">
                    ...
                    <a href="#" data-toggle="modal" data-target="#offerModal" class="btn btn-default" title="<?php echo esc_attr_e('Sell your Yacht','framework'); ?>"><i class="fa fa-dollar"></i> <span><?php echo esc_attr_e('Sell your Yacht','framework'); ?></span></a>
                    <?php } ?> -->
                </div>
            </div>
            <div class="row">
                ...
                <p><?php echo esc_attr_e('PERSONAL INFORMATION','framework'); ?></p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                <input type="email" name="Layout" class="form-control" placeholder="<?php echo esc_attr_e('Layout/Staterooms','framework'); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                <input type="email" name="Requests" class="form-control" placeholder="<?php echo esc_attr_e('Other requests','framework'); ?>">
                            </div>
                        </div>
                    </div>
