    ...
    class ReduxFramework_text_group {
        ...
        public function render () {
            $defaults = array(
                ...
                'content_title' => __ ( 'Tabs', 'redux-framework' )
            );
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $text_group as $slide ) {
                    ...
                    if ( $this->field[ 'show' ][ 'property_description' ] ) {
                        $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'property_description' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'property_description' ] ) : __ ( '', 'redux-framework' );
            ...
            if ( $x == 0 ) {
              ...
              if ( $this->field[ 'show' ][ 'property_description' ] ) {
                        $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'property_description' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'property_description' ] ) : __ ( 'Enter shortcode Ex-[content], [specifications], [features].', 'redux-framework' );
                        echo '<li><textarea name="' . $this->field[ 'name' ] . '[' . $x . '][property_description]' . $this->field['name_suffix'] . '" id="' . $this->field[ 'id' ] . '-property_description_' . $x . '" placeholder="' . $placeholder . '" class="large-text" rows="6">' . $placeholder . '</textarea></li>';
                    }
