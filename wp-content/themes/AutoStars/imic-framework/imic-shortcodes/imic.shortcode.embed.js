function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		//Dealers
		var dealers_title = document.getElementById('dealers-title').value;
		var dealers_number = document.getElementById('dealers-number').value;
		var dealers_type = document.getElementById('dealers-role').value;
		
		//Listing
		var listing_title = document.getElementById('listing-title').value;
		var listing_number = document.getElementById('listing-number').value;
		var listing_column = document.getElementById('listing-column').value;
		var listing_cats = document.getElementById('listing-cats').value;
		var listing_tags = document.getElementById('listing-tags').value;
		var listing_specs = document.getElementById('listing-specifications').value;
		var listing_view = document.getElementById('listing-view').value;
		
		//Most Viewed
		var most_title = document.getElementById('most-title').value;
		var most_number = document.getElementById('most-number').value;
		var most_view = document.getElementById('most-view').value;
		
		//Listing
		var category_title = document.getElementById('category-title').value;
		//var category_cats = document.getElementById('category-cats').value;
		
		//Featured Category
		var featcat_title = document.getElementById('featcat-title').value;
		
		//Search
		//var search_title = document.getElementById('search-title').value;
		var search_type = document.getElementById('search-type').value;
		var search_column = document.getElementById('search-column').value;
		
		//Browse Listing
		var browse_listing_title = document.getElementById('browse-listing-title').value;
		var browse_listing_value = document.getElementById('browse-listing-value').value;
		var browse_listing_specs = document.getElementById('browse-listing-specs').value;
		
		//Testimonial
		var testimonial_title = document.getElementById('testimonial-title').value;
		var testimonial_number = document.getElementById('testimonial-number').value;
		var testimonial_type = document.getElementById('testimonial-type').value;
		
		//Plan
		var plan_title = document.getElementById('plan-title').value;
		var plan_number = document.getElementById('plan-number').value;
		var plan_category = document.getElementById('plan-category').value;
		...
		if (shortcode_select == 'shortcode-staff') {
			shortcodeHTML = '<br/>[staff title="'+staff_title+'" number="'+staff_number+'" column="'+staff_column+'"]<br/>';	
		}
		////	DEALERS SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-dealers') {
			shortcodeHTML = '<br/>[dealers title="'+dealers_title+'" number="'+dealers_number+'" type="'+dealers_type+'"]<br/>';	
		}
		////	SEARCH SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-search') {
			shortcodeHTML = '<br/>[search option="'+search_type+'" column="'+search_column+'"]<br/>';	
		}
		
		////	LISTING SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-listing') {
			shortcodeHTML = '<br/>[listing title="'+listing_title+'" column="'+listing_column+'" number="'+listing_number+'" cats="'+listing_cats+'" tags="'+listing_tags+'" specs="'+listing_specs+'" view="'+listing_view+'"]<br/>';	
		}
		
		////	MOST VIEWED SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-mostviewed') {
			shortcodeHTML = '<br/>[mostviewed title="'+most_title+'" number="'+most_number+'" view="'+most_view+'"]<br/>';	
		}
		
		////	CATEGORIZE SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-category') {
			shortcodeHTML = '<br/>[categorize title="'+category_title+'"]<br/>';	
		}
		
		////	FEATURED CATEGORIZE SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-featcat') {
			shortcodeHTML = '<br/>[featcat title="'+featcat_title+'"]<br/>';	
		}
		...
		if (shortcode_select == 'shortcode-testimonial') {
			shortcodeHTML = '<br/>[testimonial title="'+testimonial_title+'" number="'+testimonial_number+'" type="'+testimonial_type+'"]<br/>';	
		}
		
		/////////////////////////////////////////
		////	PLAN SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-plan') {
			shortcodeHTML = '<br/>[plan title="'+plan_title+'" number="'+plan_number+'" term="'+plan_category+'"]<br/>';	
		}
		...
		/////////////////////////////////////////
		////	BROWSE LISTING SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-browse-listing') {
			shortcodeHTML = '<br/>[browse_listing title="'+browse_listing_title+'" value="'+browse_listing_value+'" specs="'+browse_listing_specs+'"]<br/>';	
		}
		...
		if (shortcode_select == 'shortcode-sidebar') {
			...
			shortcodeHTML = '<br/>[sidebar id="' + sidebar_listing + '"]<br/>';
