    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $current_object_id = 0) {
              ...
              ?>
                ...
                <p class="field-custom description description-wide">
                    <label for="edit-menu-is-mega-<?php echo esc_attr($item_id); ?>">
                        <input type="checkbox" id="edit-menu-is-mega-<?php echo esc_attr($item_id); ?>" class="edit-menu-item-custom megamenu"   name="menu-is-mega[<?php echo esc_attr($item_id); ?>]" value="1"<?php echo checked(!empty($item->ismega), 1, false); ?> /> <?php _e('Enable Mega Menu', 'framework'); ?>
                    </label>
                </p>
                ...
                <p class="field-custom description description-wide">
                    <label for="edit-menu-post-<?php echo esc_attr($item_id); ?>">
                        <?php _e('Enter Number of Post Ex-3','framework'); ?><input type="text" id="edit-menu-post-<?php echo esc_attr($item_id); ?>" class="menu-post edit-menu-item-custom"   name="menu-post[<?php echo esc_attr($item_id); ?>]" value="<?php echo ($item->menupost); ?>" /> 
                    </label>
                </p>
                <p class="field-custom description description-wide">
                    <label for="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>">
                        <?php _e('Enter Comma seperated value Ex-1,2,3(for  menu use M like M10)','framework'); ?><input type="text" id="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>" class="menu-post-id-comma edit-menu-item-custom"   name="menu-post-id-comma[<?php echo esc_attr($item_id); ?>]" value="<?php echo ($item->menupostidcomma); ?>" /> 
                    </label>
                </p>
                <p class="field-custom description description-wide">
        ...
        ?>
                ...
                <?php if ('custom' != $item->type && $original_title !== false) : ?>
                    ...
                    ?>"><?php _e('Remove', 'framework'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url(add_query_arg(array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg($removed_args, admin_url('nav-menus.php'))));
